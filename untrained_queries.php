...
<div class="services">
		<div class="container">
			...
			<h3 class="agileits_head" style="color:#FF6600">UNTRAINED QUERIES</h3>
			<p class="agileits_head">&nbsp;</p>
		</div>
	   
	    <form name="form1" method="post" action="">
	      <table width="958" height="87" border="0" align="center">
            <tr>
              <th scope="row"><div align="center">Id</div></th>
              <th height="46" scope="row"><div align="center"><strong>User</strong></div></th>
              <td><div align="center"><strong>Query</strong></div></td>
              <td><div align="center"><strong>Send Query </strong></div></td>
            </tr>
            <?php
		$qt=mysql_query("select * from user_search");
		while($r=mysql_fetch_array($qt))																									
			{
			?>
            <tr>
              <th scope="row"><div align="center"><?php echo $r['id'];?></div></th>
              <th scope="row"><div align="center"><?php echo $r['uname'];?></div></th>
              <td><div align="center"><?php echo $r['data'];?></div></td>
              <td><div align="center">
			  <?php
			  $sts=$r['status'];
			  if($sts==0)
			  {
			  ?>
			  <a href="send_query.php?bid=<?php echo $r['id'];?>">Answer</a>
			  <?php
			  }
			  elseif($sts==1)
			  {
			  echo "Answered This Query";
			  }
			  ?>
			  </div></td>
            </tr>
