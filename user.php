...
if(isset($_POST['btn']))
{
echo $qry=mysql_query("select * from user_register where uname='$uname' and  pass='$pass'");
...
<div class="services">
		<div class="container">
			...
			<h3 class="agileits_head" style="color:#FF6600">USER LOGIN</h3>
	    ...
	    <form name="form1" method="post" action="">
		  ...
		  <p align="center">&nbsp;</p>
							 ...
							 <p align="center" style="color:#FF9933"><a href="register.php">NEW USER REGISTRATION</a></p>
