				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav>
						<ul class="nav navbar-nav link-effect-5" id="link-effect-5">
							...
							<li class="active"><a href="training_data.php" data-hover="TRAINING">TRAINING</a></li>
...
<div class="services">
		<div class="container">
			...
			<h3 class="agileits_head" style="color:#FF6600">TRAINING DATASET</h3>
			<p class="agileits_head">&nbsp;</p>
		</div>
	   
	    <form name="form1" method="post" action="" enctype="multipart/form-data">
	      <table width="395" height="72" border="0" align="center">
            <tr>
              <th scope="row">Select Your Dataset </th>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <th scope="row"><label>
              ...
              <td><label>
                <input name="btn" type="submit" id="btn" value="Training">
              </label></td>
            </tr>
          </table>
	      <p align="center">&nbsp;</p>
							...
							move_uploaded_file($file_tmp,"upload/Fertilizer.csv");
							?>
							...
							while (($line = fgetcsv($file)) !== FALSE) 
							{
		 					 ?>
                               <tr>
                                 <td><?php  print_r($line[0]);?></td>
                                 <td><?php  print_r($line[1]);?></td>
                                 <td><?php  print_r($line[2]);?></td>
                                 <td><?php  print_r($line[3]);?></td>
                                 <td><?php  print_r($line[4]);?></td>
                                 <td><?php  print_r($line[5]);?></td>
                                 <td><?php  print_r($line[6]);?></td>
                                 <td><?php  print_r($line[7]);?></td>
                                 <td><?php  print_r($line[8]);?></td>
                               </tr>
							   <?php
							   }
							   ?>
