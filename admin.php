...
if(isset($_POST['btn']))
{
echo $qry=mysql_query("select * from admin where uname='$uname' and  pass='$pass'");
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav>
						<ul class="nav navbar-nav link-effect-5" id="link-effect-5">
							...
							<li class="active"><a href="admin.php" data-hover="Admin">ADMIN</a></li>
							<li><a href="user.php" data-hover="User">USER</a></li>
						</ul>
...
<div class="services">
		<div class="container">
			...
			<h3 class="agileits_head" style="color:#FF6600">ADMIN LOGIN</h3>
			<p class="agileits_head">&nbsp;</p>
		</div>
	   
	    <form name="form1" method="post" action="">
	      <table width="376" height="206" border="0" align="center">
            <tr>
