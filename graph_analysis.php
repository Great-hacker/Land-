				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav>
						<ul class="nav navbar-nav link-effect-5" id="link-effect-5">
							...
							<!--<li class="active"><a href="graph_analysis.php" data-hover="GRAPH ANALYSIS">GRAPH ANALYSIS</a></li>-->
...
<div class="services">
		<div class="container">
			...
			<h3 class="agileits_head" style="color:#FF6600">GRAPH ANALYSIS</h3>
	...
	unlink("test1.jpg");
  include("test.php");
  //include("jpgraph/src/Examples/canvasex04.php");
?>
              </div>
