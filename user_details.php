				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav>
						<ul class="nav navbar-nav link-effect-5" id="link-effect-5">
							<li><a href="admin_home.php" data-hover="Home">HOME</a></li>
							<li><a href="training_data.php" data-hover="TRAINING">TRAINING</a></li>
							<li class="active"><a href="user_details.php" data-hover="USER DETAILS">USER DETAILS</a></li>
...
<div class="services">
		<div class="container">
			...
			<h3 class="agileits_head" style="color:#FF6600">USER DETAILS</h3>
			<p class="agileits_head">&nbsp;</p>
		</div>
	   
	    <form name="form1" method="post" action="">
	      <table width="958" height="78" border="0" align="center">
            <tr>
			...
			<?php
		$qt=mysql_query("select * from user_register");
		while($r=mysql_fetch_array($qt))																									
			{
			?>
            <tr>
              <th scope="row"><div align="center"><?php echo $r['name'];?></div></th>
              <td><div align="center"><?php echo $r['contact'];?></div></td>
              <td><div align="center"><?php echo $r['address'];?></div></td>
              <td><div align="center"><?php echo $r['email'];?></div></td>
              <td><div align="center"><?php echo $r['district'];?></div></td>
              <td><div align="center"><?php echo $r['area'];?></div></td>
              <td><div align="center"><?php echo $r['rdate'];?></div></td>
            </tr>
			<?php
						}
						?>
